...
<div class="cardOnTable" id="cardOnTable-\${posX}-\${posY}" style="grid-column:\${posX} / span \${sizeX}; grid-row:\${posY} / span \${sizeY}; z-index:\${index};">
    <div class='card' data-filp='\${filp}' style="background-position:-\${x}px -\${y}px; transform: translate(\${angle}%, 0px)"></div>
</div>
`
...
var jstpl_players = `
<div class="blaze-player" id="blaze-player-\${playerId}" data-pos="\${playerPos}" data-role="none">
    <div class="player-container" id="player-container-\${playerId}">
