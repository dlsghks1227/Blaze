        ...
        return declare("bgagame.blaze", [
            ...
            */
            ...
            setup: function (gamedatas) {
                ...
                dojo.connect(this._attackCardPlace, "onChangeSelection", this, 'onAttackPlaceSelectionChanged');
                ...
                this.placeCard(1, 2, this.gamedatas.trumpSuitCard.type, this.gamedatas.trumpSuitCard.value, 1, 1, false, 50, 0);
                    ...
                    switch (stateName) {
                        case 'playerTurn':
                            if (args.activePlayerRole == '1') {
                                ...
                                var tempCount = args.DefenderCardsCount > 5 ? 5 : args.DefenderCardsCount;
                                if (tempCount == this._attackCardPlace.getAllItems().length) {
                                ...
                                args.attackedCard.forEach(atCard => {
